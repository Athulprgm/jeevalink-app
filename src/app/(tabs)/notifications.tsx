...
import { Siren, MapPin, Trophy, CheckCircle, Check, BellOff } from 'lucide-react-native';
...
export default function NotificationsScreen() {
  const { notifications, markNotificationRead, markAllNotificationsRead, fetchNotifications } = useAppStore();
        ...
        {notifications.map((notif) => {
          ...
          return (
            <TouchableOpacity
              ...
              onPress={() => markNotificationRead(notif._id)}
            >
              {/* Icon */}
              <View
